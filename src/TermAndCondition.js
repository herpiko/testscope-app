    ...
    return (
      <EuiFlexGroup wrap>
        ...
        <div className={'page-title'}>Terms of Service</div>
          <EuiPanel
            style={{ marginTop: 15, textAlign: 'left', lineHeight: '1.4em', marginBottom:30}}
          >
            <article
              class="markdown-body entry-content container-lg"
              itemprop="text"
            >
              <p style={{fontSize:12}}>Updated at 2021-05-30</p>
              <br />
              <hr />
              <br />
              <br />
              <h2 style={{ fontWeight: 'bold' }}>General Terms</h2>
              <br />
              <p>
                By accessing and placing an order with {Config.projectName}, you confirm
                that you are in agreement with and bound by the terms of service
                contained in the Terms &amp; Conditions outlined below. These
                terms apply to the entire website, services and any email or
                other type of communication between you and {Config.projectName}.
              </p>
              <br />
              <p>
                ...
                site, even if team or an authorized representative has been
              ...
              <br />
              <br />
              <h2 style={{ fontWeight: 'bold' }}>License</h2>
              <br />
              <p>
                {Config.projectName} grants you a revocable. non-exclusive.
                non-transferable, limited license to use our service strictly in
                accordance with the terms of this Agreement.
              </p>
              <br />
              <p>
                These Terms &amp; Conditions are a contract between you and
                {Config.projectName} (referred to in these Terms &amp; Conditions as
                "{Config.projectName}", "us", "we" or "our"). the provider of the
                {Config.projectName} website and the services accessible from the
                {Config.projectName} website (which are collectively referred to in
                these Terms &amp; Conditions as the "{Config.projectName} Service").
              </p>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Definitions and key terms</h1>
              <br />
              <p>For this Terms &amp; Conditions:</p>
              <br />
              <ul style={{ listStyleType: 'circle', paddingLeft: 15 }}>
                <li>
                ...
                <li>
                  ...
                  "our", it refers to {Config.projectName} that is responsible for your
                  information under this Privacy Policy.
                </li>
                <li>
                  Country: where {Config.projectName} or the owners/founders of
                  {Config.projectName} are based, in this case is Indonesia.
                </li>
                <li>
                  Customer: refers to the company, organization or person that
                  signs up to use the {Config.projectName} Service to manage the
                ...
                <li>
                  ...
                  {Config.projectName} and use the services.
                </li>
                <li>
                ...
                <li>
                  ...
                  {Config.projectName} or are under contract to perform a service on
                ...
                <li>
                  Service: refers to the service provided by {Config.projectName} as
                ...
                <li>
                  Website:i {Config.projectName}'s site, which can be accessed via this
                  URL:{' '}
                  <a href={'https://' + Config.projectDomain + '.' + Config.projectDomainTld} rel="nofollow">
                    https://{Config.projectDomain + '.' + Config.projectDomainTld}
                  </a>
                  .
                </li>
                <li>
                  You: a person or entity that is registered with {Config.projectName}
                  to use the services.
                </li>
              </ul>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Restrictions</h1>
              <br />
              ...
              <br />
              <p>
                If you pay for any of our one-time payment plans, you agree to
                ...
                the time that each fee or charge is due and payable.i Your
                Payment Provider agreement governs your use of the designated
                credit card account, and you must refer to that agreement and
                not these Terms to determine your rights and liabilities with
                respect to your Payment Provider. By providing us with your
                credit card number and associated payment information, you agree
                that we are authorized to verify information immediately, and
                subsequently invoice your account for all fees and charges due
                and payable to us hereunder and that no additional notice or
                consent is required. You agree to immediately notify us of any
                change in your billing address or the credit card used for
                payment hereunder. We reserve the right at any time to change
                its prices and billing methods, either immediately upon posting
                ...
                the responsibility of and paid for by you. No contract will
                exist between you and us for the Service until we accept your
                order by a appropriate means of communication. You are
                responsible for any third-party fees that you may incur when
                using the Service.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Return and Refund Policy</h1>
              <br />
              <p>
                Thanks for using our paid services. We appreciate the fact that
                you like to pay the stuff we build.i We also want to make sure
                you have a rewarding experience while you're exploring,
                evaluating, and purchasing our products.
              </p>
              <br />
              <p>
                As with any purchase experience, there are terms and conditions
                that apply to transactions at our company. The main thing to
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Your Suggestions</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Your Consent</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Links to Other Websites</h1>
              <br />
              <p>
                Our service may contain links to other websites that are not
                operated by Us. If you click on a third party link, you will be
                directed to that third party's site. We strongly advise you to
                review the Terms &amp; Conditions of every site you visit. We
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Cookies</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Updates to Our service</h1>
              <br />
              <p>
                ...
                ("Updates"). Updates may modify or delete certain features
                and/or functionalities of the service.You agree that we have no
                obligation to (i) provide any Updates, or (ii) continue to
                provide or enable any particular features and/or functionalities
                of the service to you. You further agree that all Updates will
                be (i) deemed to constitute an integral part of the service, and
                (ii) subject to the terms and conditions of this Agreement.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Third-Party Services</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Term and Termination</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Copyright Infringement</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Indemnification</h1>
              <br />
              <p>
                ...
                your: (a) use of the service; (b) violation of this Agreement or
                any law or regulation; or (c) violation of any right of a third
                party.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>No Warranties</h1>
              <br />
              <p>
                ...
                warranties, whether express, implied,statutory or otherwise,i
                with respect to the service, including all implied warranties of
                merchantability, fitness for a particular purpose, title and
                non-infringement, and warranties that may arise out of course of
                dealing,i course of performance, usage or trade practice.
              ...
              <p>
                ...
                or on behalf of us are free of viruses, scripts, trojan horses,
              ...
              <p>
                ...
                this Agreement and your exclusive remedy for all of the
                ...
                with the service,or otherwise in connection with any provision
                of this Agreement), even if we or any supplier has been advised
                of the possibility of such damages and even if the remedy fails
                of its essential purpose. Some states/jurisdictions do not allow
                the exclusion or limitation of incidental or consequential
                damages, so the above limitation or exclusion may not apply to
                you.
              </p>
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Severability</h1>
              <br />
              <p>
                ...
                provisions will continue in fullforce and effect.
              </p>
              <br />
              <p>
                ...
                this Agreement, which shall remain in fullforce and effect. No
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Waiver</h1>
              <br />
              <p>
              ...
              <p>
                ...
                terms, you are no longer authorized to use our service.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Entire Agreement</h1>
              <br />
              <p>
                ...
                apply when you use or purchase other services from us, which we
                will provide to you at the time of such use or purchase.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Updates to Our Terms</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Intellectual Property</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Agreement to Arbitrate</h1>
              <br />
              <p>
                ...
                REGARDING THE ENFORCEMENT OR VALIDITY OF YOUR OR {Config.projectName}'s
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Notice of Dispute</h1>
              <br />
              <p>
                ...
                <a href="mailto:herpiko@aguno.xyz">herpiko@aguno.xyz</a>. We
                will send any Notice of Dispute to you by mailto your address if
                we have it, or otherwise to your emailaddress. You and us will
                attempt to resolve any dispute through informal negotiation
                within sixty (60) days from the date the Notice of Dispute is
                sent. After sixty (60) days, you or us may commence arbitration.
              </p>
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Binding Arbitration</h1>
              <br />
              <p>
                If you and us don't resolve any dispute by informal negotiation,
                any other eff ort to resolve the dispute will be conducted
                ...
                Indonesia Arbitration Association. Either party may seek any
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Submissions and Privacy</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Promotions</h1>
              <br />
              <p>
                ...
                may contain certain eligibilit requirements, such as
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Typographical Errors</h1>
              <br />
              <p>
              ...
              <br />
              <br />
              <h1 style={{ fontWeight: 'bold' }}>Miscellaneous</h1>
              <br />
              <p>
                ...
                writing and signed by an authorized representative of us. We
                will be entitled to injunctive or other equitable relief
                (without the obligations of posting any bond or surety) in the
                event of any breach or anticipatory breach by you.We operate and
                control our Service from our offices in. The Service is not
                ...
                Terms &amp; Conditions (which include and incorporate our
                Privacy Policy) contains the entire understanding,and supersedes
                all prior understandings, between you and us concerning its
              ...
              <p>
                ...
                event shall we be liable for any special,direct,
                ...
                or the contents of the Service. We reserve the right to make
                additions, deletions, or modifications to the contents on the
                Service at any time without prior notice. Our Service and its
                contents are provided "as is" and "as available" without any
                ...
                purpose or non-infringement of third party rights.No oral advice
                ...
                change without notice. Without limiting the foregoing, we do not
                warrant that our Service will be uninterrupted, uncorrupted,
              ...
              <ul style={{ listStyleType: 'circle', paddingLeft: 15 }}>
                <li>
                  Email address:{' '}
                  <a href="mailto:herpiko@gmail.com">herpiko@aguno.xyz</a>
                </li>
              </ul>
            </article>
          </EuiPanel>
